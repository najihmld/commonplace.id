...
const components = {
  h1: (props: HeadingProps) => (
    <h1 className="mb-2 text-2xl font-medium" {...props} />
  ),
  h2: (props: HeadingProps) => (
    <h2
      className="text-xl font-medium text-gray-800 dark:text-zinc-200"
      {...props}
    />
  ),
  h3: (props: HeadingProps) => (
    <h3
      className="text-base font-medium text-gray-800 dark:text-zinc-200"
      {...props}
    />
  ),
